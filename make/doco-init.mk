...
ifdef NR		#----- newrelic
	export OTEL_OTLP_CONFIG = newrelic.yml
else ifdef HC	#----- honeycomb
	export OTEL_OTLP_CONFIG = honeycomb.yml
else ifdef DD	#----- datadog
	export OTEL_OTLP_CONFIG = datadog.yml
	...
	export OTEL_OTLP_CONFIG = grafana-loki-tempo.yml
	...
	export OTEL_OTLP_CONFIG = grafana-loki-jaeger.yml
endif
